...
// Update the Toolbar component to receive and use editorState
export default function Toolbar({ onFormatText, editorState = {} }) {
  const formatOptions = [
    {
      icon: <Bold size={18} />,
      format: "bold",
    ...
    { divider: true },
    {
      ...
      format: "justifyLeft",
      title: "Align Left",
      isActive: editorState.isJustifyLeft,
    },
    {
      icon: <AlignCenter size={18} />,
      format: "justifyCenter",
      title: "Align Center",
      isActive: editorState.isJustifyCenter,
    },
    {
      icon: <AlignRight size={18} />,
      format: "justifyRight",
      title: "Align Right",
      isActive: editorState.isJustifyRight,
    },
    {
      icon: <AlignJustify size={18} />,
      format: "justifyFull",
      title: "Justify",
      isActive: editorState.isJustifyFull,
    },
    { divider: true },
    {
      icon: <List size={18} />,
  ...
  const handleFontSizeChange = (e) => {
    document.execCommand(
      "fontSize",
      false,
      getClosestFontSize(Number.parseInt(e.target.value))
    );
  };
